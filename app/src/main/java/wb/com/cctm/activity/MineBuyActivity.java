...
public class MineBuyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appendMainBody(this,R.layout.activity_mine_buy);
    ...
    private void initview() {
        ...
        recyc_list.setLayoutManager(new LinearLayoutManager(MineBuyActivity.this));
        ...
        adpter.setOnItemClickListener(new OnItemClickListener<MybuyBean>() {
            ...
            public void onClick(MybuyBean mybuyBean, View view, int position) {
                Intent intent = new Intent(MineBuyActivity.this, OrderDetailActivity.class);
    ...
    private void buyList(String type) {
        ...
        MXUtils.httpPost(requestParams,new CommonCallbackImp("MARKET - 买单列表",requestParams, MineBuyActivity.this){
            @Override
            public void onSuccess(String data) {
                ...
                if (result.equals(FlowAPI.SUCCEED)) {
                    ...
                    ToastUtils.toastutils(message,MineBuyActivity.this);
                }
